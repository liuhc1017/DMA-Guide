...
What does this fix or improve? Link any related issue.

## Evidence and validation

- Official sources and review date:
- Links/images/Markdown checked:
- Device/OS actually tested, if any (no identifying information):
- What remains unverified:

## Checklist

- [ ] Preserves the guide's Singapore/MOE scope and original managed Windows environment.
